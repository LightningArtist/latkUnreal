...
latkUnreal-Linux-Debug:
	 $(PROJECTBUILD) latkUnreal Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

latkUnreal-Linux-DebugGame:
	 $(PROJECTBUILD) latkUnreal Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

latkUnreal-Linux-Shipping:
	 $(PROJECTBUILD) latkUnreal Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

latkUnreal-Linux-Test:
	 $(PROJECTBUILD) latkUnreal Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

latkUnreal:
	 $(PROJECTBUILD) latkUnreal Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

latkUnrealEditor-Linux-Debug:
	 $(PROJECTBUILD) latkUnrealEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

latkUnrealEditor-Linux-DebugGame:
	 $(PROJECTBUILD) latkUnrealEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

latkUnrealEditor-Linux-Shipping:
	 $(PROJECTBUILD) latkUnrealEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

latkUnrealEditor-Linux-Test:
	 $(PROJECTBUILD) latkUnrealEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

latkUnrealEditor:
	 $(PROJECTBUILD) latkUnrealEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
