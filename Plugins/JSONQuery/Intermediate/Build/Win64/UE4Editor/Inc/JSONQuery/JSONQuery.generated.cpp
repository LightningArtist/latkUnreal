...
// Cross Module References
	...
	UEnum* Z_Construct_UEnum_JSONQuery_EJSONResult()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJSONResult::Success")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJSONResult::HttpFailed")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJSONResult::JSONParsingFailed")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJSONResult::EJSONResult_MAX")), 3));
	...
	uint32 Get_Z_Construct_UEnum_JSONQuery_EJSONResult_CRC() { return 2659096227U; }
