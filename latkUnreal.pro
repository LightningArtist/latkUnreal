...
latkUnrealRootPath=/home/nick/GitHub/latkUnreal

gameProjectFile=/home/nick/GitHub/latkUnreal/latkUnreal.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(latkUnrealSource.pri)
include(latkUnrealHeader.pri)
include(latkUnrealConfig.pri)
include(latkUnrealIncludes.pri)
include(latkUnrealDefines.pri)
...
latkUnreal-Linux-Debug.commands = $$build latkUnreal Linux Debug  -project="\"$$gameProjectFile\"" $$args
latkUnreal-Linux-DebugGame.commands = $$build latkUnreal Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
latkUnreal-Linux-Shipping.commands = $$build latkUnreal Linux Shipping  -project="\"$$gameProjectFile\"" $$args
latkUnreal-Linux-Test.commands = $$build latkUnreal Linux Test  -project="\"$$gameProjectFile\"" $$args
latkUnreal.commands = $$build latkUnreal Linux Development  -project="\"$$gameProjectFile\"" $$args

latkUnrealEditor-Linux-Debug.commands = $$build latkUnrealEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
latkUnrealEditor-Linux-DebugGame.commands = $$build latkUnrealEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
latkUnrealEditor-Linux-Shipping.commands = $$build latkUnrealEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
latkUnrealEditor-Linux-Test.commands = $$build latkUnrealEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
latkUnrealEditor.commands = $$build latkUnrealEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	latkUnreal-Linux-Debug \
	latkUnreal-Linux-DebugGame \
	latkUnreal-Linux-Shipping \
	latkUnreal-Linux-Test \
	latkUnreal \
	latkUnrealEditor-Linux-Debug \
	latkUnrealEditor-Linux-DebugGame \
	latkUnrealEditor-Linux-Shipping \
	latkUnrealEditor-Linux-Test \
	latkUnrealEditor \
